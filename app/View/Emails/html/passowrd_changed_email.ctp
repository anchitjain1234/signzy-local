          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
              <tbody><tr>
                  ...
                  <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                      ...
                      Your password has been changed on VerySure.<br>
                      Click on the below button if you didn't changed your password.
                  </td>
              </tr>
          </tbody></table>
              ...
              <tbody>
                  <tr>
                      <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 20px;">
                          <a class="mcnButton " title="I didn't changed password" href="mailto:contact@verysure.com" target="_blank" style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #D55258;">I didn't changed password</a>
                      </td>
                  </tr>
              </tbody>
          </table>
