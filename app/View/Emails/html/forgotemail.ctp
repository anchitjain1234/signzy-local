          ...
          <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
              <tbody><tr>
                  ...
                  <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                      ...
                      Click the below button to change your password. Ignore this mail if you didn't clicked on forgot password.
                  </td>
              </tr>
          </tbody></table>
              ...
              <tbody>
                  <tr>
                      <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 20px;">
                          <a class="mcnButton " title="Change my Password" href="<?php echo $forgot_email_verification_link ?>" target="_blank" style="font-weight: bold;letter-spacing: 1px;line-height: 100%;text-align: center;text-decoration: none;color: #D55258;">Change my Password</a>
                      </td>
                  </tr>
              </tbody>
          </table>
