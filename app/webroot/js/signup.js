...
jQuery(document).ready(function () {
    ...
    $.showing_company_signup = function ()
    {
        //show_company_signup will be used to show company signup page directly without showing user signup page.
        ...
        $('#useremail_label').text('Company email address:');
    };

    $.showing_user_signup = function ()
    {
        ...
        $('#useremail_label').text('Email address:');
    };

    if (localStorage.getItem("show_company_signup") === "0")
    {
        $.showing_user_signup();
    }
    else if (localStorage.getItem("show_company_signup") === "1")
    {
        $.showing_company_signup();
    }
    ...
    $('#signup_as_company_btn').click($.showing_company_signup);
    $('#signup_as_individual_btn').click($.showing_user_signup);
});
