...
jQuery(document).ready(function () {
  ...
  $.pwd_confirmation = function()
  {
    ...
    if(pwd !== pwd_reenter || pwd ==="")
    {
      ...
      $('#renter_password').tooltip({title: "<div>Password does not matches.</div>", animation: true , placement: 'right' , html : true , trigger: "hover focus"});
    }
    else
    {
      pwdreentererror = 0;
  ...
  $.pwd_check = function ()
  {
    ...
    if (score <26 || pwd==="") {
      ...
      $('#password').tooltip({title: "<div>Please enter more secure password</div>", animation: true , placement: 'right' , html : true , trigger: "hover focus"});
    } 
    else{
      pwderror = 0;
  ...
  $.email_check = function ()
  {
    ...
    if (!isValidEmailAddress( email_entered )) 
    {
      ...
      $('#useremail').tooltip({title: "<div>Please enter valid email address</div>", animation: true , placement: 'right' , html : true , trigger: "hover focus"});
    } 
    else{
      emailerror = 0;
